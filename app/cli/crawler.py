...
from app.incidents.incident_crawler import run_crawler
...
def _generate_scenarios(db_path: str, output_dir: str):
    ...
    eligible = [inc for inc in incidents if inc.taxonomy_labels and inc.quality_score >= MIN_QUALITY_FOR_SCENARIO]
